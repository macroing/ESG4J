...
public final class StoreViewSourceModel {
	private String moduleName;
	private String vendorName;
	
	////////////////////////////////////////////////////////////////////////////////////////////////////
	
	public StoreViewSourceModel() {
		this("Module", "Vendor");
	}
	
	public StoreViewSourceModel(final String moduleName, final String vendorName) {
	...
	public File getRelativeFile() {
		return new File(String.format("%s/%s/Model/Config/SourceModel/StoreViewSourceModel.php", Strings.formatCamelCase(getVendorName()), Strings.formatCamelCase(getModuleName())));
	}
	...
	public PDocument toDocument() {
		...
		pClass.setName("StoreViewSourceModel");
		pClass.sort();
		...
		pDocument.addUse("Magento\\Store\\Model\\ResourceModel\\Store\\CollectionFactory");
	...
	public String toString() {
		return String.format("new StoreViewSourceModel(\"%s\", \"%s\")", this.moduleName, this.vendorName);
	}
	...
	public boolean equals(final Object object) {
		if(object == this) {
			return true;
		} else if(!(object instanceof StoreViewSourceModel)) {
			return false;
		} else if(!Objects.equals(this.moduleName, StoreViewSourceModel.class.cast(object).moduleName)) {
			return false;
		} else if(!Objects.equals(this.vendorName, StoreViewSourceModel.class.cast(object).vendorName)) {
			return false;
		} else {
			return true;
		}
