...
public final class CustomerGroupSourceModel {
	private String moduleName;
	private String vendorName;
	
	////////////////////////////////////////////////////////////////////////////////////////////////////
	
	public CustomerGroupSourceModel() {
		this("Module", "Vendor");
	}
	
	public CustomerGroupSourceModel(final String moduleName, final String vendorName) {
	...
	public File getRelativeFile() {
		return new File(String.format("%s/%s/Model/Config/SourceModel/CustomerGroupSourceModel.php", Strings.formatCamelCase(getVendorName()), Strings.formatCamelCase(getModuleName())));
	}
	...
	public PDocument toDocument() {
		...
		pMethodToOptionArray.getBlock().addLine("	$this->optionArray = $this->collectionFactory->create()->toOptionArray();");
		...
		pClass.setName("CustomerGroupSourceModel");
		pClass.sort();
		
		final
		PDocument pDocument = new PDocument();
		pDocument.addClass(pClass);
		pDocument.addUse("Magento\\Customer\\Model\\ResourceModel\\Group\\CollectionFactory");
	...
	public String toString() {
		return String.format("new CustomerGroupSourceModel(\"%s\", \"%s\")", this.moduleName, this.vendorName);
	}
	...
	public boolean equals(final Object object) {
		if(object == this) {
			return true;
		} else if(!(object instanceof CustomerGroupSourceModel)) {
			return false;
		} else if(!Objects.equals(this.moduleName, CustomerGroupSourceModel.class.cast(object).moduleName)) {
			return false;
		} else if(!Objects.equals(this.vendorName, CustomerGroupSourceModel.class.cast(object).vendorName)) {
			return false;
		} else {
			return true;
		}
